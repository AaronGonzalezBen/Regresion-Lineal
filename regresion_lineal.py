"""
Algoritmo de Regresion Lineal sin librerias de ML

El objetivo es encontrar una linea recta que mejor se ajuste
a la totalidad de los datos

Funcion de costo o perdida:

Mide el rendimiento de una aproximacion, en este caso de
una Regresion Lineal

- Error Cuadratico Medio (ECM): Promedia todas las distancias
entre los puntos reales y la aproximacion de la Regresion Lineal
(yi - y'i) donde yi son los puntos reales y y'i los puntos de la
aproximacion
"""

# Algoritmo de Regresion Lineal para evaluacion de presion
# sanguinea a partir de la edad
